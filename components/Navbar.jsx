    ...
    <div style={{backgroundColor: `${navBg}`}} className={shadow? 'fixed top-0 left-0 w-full h-20 shadow-xl z-[100]': 'fixed w-full h-20 z-[100]'}>
        <div className='flex justify-between  items-center w-full h-full px-2 2xl:px-16'>
          <Link href='/'>
            ...
            <h3 className=' text-xs text-purple-400 font-medium'>Kawayankulama</h3>
            </div>
        </Link>
      ...
      >Contact</li>
            ...
            <div onClick={handleNav} className='md:hidden pr-5'>
              <AiOutlineMenu size={25} className='text-purple-500'/>
            </div>
           </div>
        </div>
              ...
              : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'
                ...
                <div>
                    <div className='flex w-full items-center justify-between'>
                      <Link href='/'>
                    <Image src={logo} width='94' height='94' alt='/' className='rounded-lg'/></Link>
                        <div onClick={handleNav}className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer text-purple-500'>
                            <AiOutlineClose/>
                        </div>
                    </div>
                    <div className ='border-b border-t-gray-300 my-4'>
                        <p className ='w-[85%] md:w-[90%] py-4 font-extrabold text-purple-300'>Kawayankulama Health Division</p>
                    </div>
                </div>
                <div className='py-4 flex flex-col'>
                    <ul className='uppercase text-purple-400'>
                        <Link href='/'>
