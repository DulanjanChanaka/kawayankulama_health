...
function Threeposha() {
  ...
  return (
    <div className='w-full bg-purple-200 h-screen'>
      ...
      {data.map((item, id)=>(
          <div key={id} className='pt-[100px] px-3 '>
            <div className=' text-white p-2 pb-3 bg-purple-400'>
            <div className='text-lg text-center font-bold py-3 text-purple-800'>{item.title}</div>
            <div className='bg-white py-[1px] '/>
          <div className='text-center pt-2 text-white'>{item.message}</div>
            </div>
